...
public class MainActivity extends AppCompatActivity {
    ...
    double[] coordenadas_objeto = {0, 0, 0, 0};
    ...
    public void buttonStartCamera(View view) {
        ...
        // Configura el ImageReader para capturar imágenes en formato YUV_420_888
        ...
        try {
            ...
            captureRequestBuilder.addTarget(imageReader.getSurface()); // Agrega el ImageReader como target
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            try {
                ...
                if (image != null) {
                    ...
                    image.close();
                    // Enviamos el Bitmap al servidor Flask

                    sendBitmapToServer(bitmap, "upload1");
                    double[] coordenadas_objeto1 = coordenadas_objeto;

                    sendBitmapToServer(bitmap, "upload2");
                    double[] coordenadas_objeto2 = coordenadas_objeto;


                    android.graphics.Bitmap bOut = bitmap.copy(bitmap.getConfig(), true);
                    graficar(bitmap, bOut, coordenadas_objeto1, coordenadas_objeto2);
    ...
    private Bitmap imageToBitmap(Image image) {
        ...
        // Copiamos los planos U y V en formato intercalado
        int uvIndex = ySize;
    ...
    private void sendBitmapToServer(Bitmap bitmap, String endpoint) {
        ...
        Request request = new Request.Builder()
                .url("http://192.168.18.162:5000/"+endpoint)
                .post(requestBody)
                .build();
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    coordenadas_objeto = coordenadas(jsonObject);
    ...
    public native double[] coordenadas(JsonObject jsonObject);

    public native void graficar(android.graphics.Bitmap in, android.graphics.Bitmap out, double[] doubleArray1, double[] doubleArray2);
